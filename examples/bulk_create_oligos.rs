...
async fn main() {
    ...
    let response = client
        ...
        .oligos(
            vec![
                OligoCreate(OligoBaseRequestForCreate(OligoBaseRequest { bases :
                Some("your bases".to_owned()), author_ids : Some(vec!["your author ids"
                .to_owned()]), custom_fields : Some(CustomFields {}), fields :
                Some(Fields {}), folder_id : Some("your folder id".to_owned()), name :
