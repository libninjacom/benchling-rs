...
async fn main() {
    ...
    let custom_entities = vec![
        ...
        aliases : Some(vec!["your aliases".to_owned()]), author_ids :
        Some(vec!["your author ids".to_owned()]), name : Some("your name".to_owned()),
        schema_id : Some("your schema id".to_owned()), custom_fields : Some(CustomFields
