    ...
    let response = client
        ...
        .mixtures(
            vec![
                ...
                MixtureUpdate { fields : Some(Fields {}), amount : Some("your amount"
                .to_owned()), ingredients : Some(vec![IngredientWriteParams { notes :
                Some("your notes".to_owned()), component_lot_text :
                ...
                "your component entity id".to_owned() }]), name : Some("your name"
                .to_owned()), schema_id : Some("your schema id".to_owned()), folder_id :
                Some("your folder id".to_owned()), units : Some("your units".to_owned()),
                aliases : Some(vec!["your aliases".to_owned()]), custom_fields :
                Some(CustomFields {}), entity_registry_id :
                Some("your entity registry id".to_owned()), author_ids :
                Some(vec!["your author ids".to_owned()]) } }
            ],
        )
        .send()
        .await
