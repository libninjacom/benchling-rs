...
async fn main() {
    ...
    let response = client
        ...
        .mixtures(
            vec![
                MixtureBulkUpdate(MixtureUpdate { custom_fields : Some(CustomFields {}),
                ingredients : Some(vec![IngredientWriteParams { units : Some("your units"
                ...
                folder_id : Some("your folder id".to_owned()), fields : Some(Fields {}),
                units : Some("your units".to_owned()), schema_id : Some("your schema id"
                .to_owned()), author_ids : Some(vec!["your author ids".to_owned()]),
                entity_registry_id : Some("your entity registry id".to_owned()), name :
                Some("your name".to_owned()), amount : Some("your amount".to_owned()) },
                ::serde_json::json!({}))
            ],
        )
        .send()
