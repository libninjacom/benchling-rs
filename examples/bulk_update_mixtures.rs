...
async fn main() {
    ...
    let response = client
        ...
        .mixtures(
            vec![
                MixtureBulkUpdate { mixture_update : MixtureUpdate { folder_id :
                ...
                Some("your notes".to_owned()), component_entity_id :
                "your component entity id".to_owned(), catalog_identifier :
                Some("your catalog identifier".to_owned()), component_lot_container_id :
                ...
                units : Some("your units".to_owned()), aliases : Some(vec!["your aliases"
