...
async fn main() {
    ...
    let mixtures = vec![
        MixtureCreate { mixture_update : MixtureUpdate { schema_id :
        Some("your schema id".to_owned()), amount : Some("your amount".to_owned()),
        custom_fields : Some(CustomFields {}), fields : Some(Fields {}), aliases :
        Some(vec!["your aliases".to_owned()]), entity_registry_id :
        ...
        "your component entity id".to_owned(), amount : Some("your amount".to_owned()),
        units : Some("your units".to_owned()), notes : Some("your notes".to_owned()) }]),
        name : Some("your name".to_owned()), units : Some("your units".to_owned()),
        folder_id : Some("your folder id".to_owned()), author_ids :
        Some(vec!["your author ids".to_owned()]) }, create_entity_into_registry :
        CreateEntityIntoRegistry { entity_registry_id : Some("your entity registry id"
        .to_owned()), naming_strategy : Some("your naming strategy".to_owned()),
        registry_id : Some("your registry id".to_owned()), folder_id :
        Some("your folder id".to_owned()) } }
    ];
