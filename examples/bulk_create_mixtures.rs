...
async fn main() {
    ...
    let mixtures = vec![
        MixtureCreate { mixture_update : MixtureUpdate { fields : Some(Fields {}), name :
        Some("your name".to_owned()), author_ids : Some(vec!["your author ids"
        .to_owned()]), amount : Some("your amount".to_owned()), entity_registry_id :
        ...
        Some("your component lot entity id".to_owned()), amount : Some("your amount"
        .to_owned()), component_entity_id : "your component entity id".to_owned() }]),
        custom_fields : Some(CustomFields {}), units : Some("your units".to_owned()),
