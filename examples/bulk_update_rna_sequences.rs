    ...
    let response = client
        ...
        .rna_sequences(
            vec![
                ...
                RnaSequenceBaseRequest { annotations : Some(vec![RnaAnnotation { strand :
                1, sequence_feature_base : SequenceFeatureBase { color :
                ...
                Some("your notes".to_owned()), name : Some("your name".to_owned()) },
                type_ : "your type".to_owned(), end : 1, start : 1 }]), is_circular :
                Some(true), translations : Some(vec![Translation { sequence_feature_base
                ...
                .to_owned()) }, end : 1, strand : 1, genetic_code : "your genetic code"
                .to_owned(), regions : vec![::serde_json::json!({})], start : 1,
                amino_acids : "your amino acids".to_owned() }]), custom_fields :
