    ...
    let response = client
        ...
        .rna_sequences(
            vec![
                ...
                RnaSequenceBaseRequest { name : Some("your name".to_owned()), annotations
                : Some(vec![RnaAnnotation { end : 1, type_ : "your type".to_owned(),
                strand : 1, sequence_feature_base : SequenceFeatureBase { custom_fields :
                ...
                .to_owned(), amino_acids : "your amino acids".to_owned() }]) }, id :
                "your id".to_owned() }
            ],
        )
        .send()
