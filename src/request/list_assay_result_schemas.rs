...
pub struct ListAssayResultSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
    pub modified_at: Option<String>,
}
impl<'a> ListAssayResultSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<AssayResultSchemasPaginatedList> {
        let mut r = self.client.client.get("/assay-result-schemas");
