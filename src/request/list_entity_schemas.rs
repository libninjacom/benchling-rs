...
pub struct ListEntitySchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
    pub modified_at: Option<String>,
}
impl<'a> ListEntitySchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<EntitySchemasPaginatedList> {
        let mut r = self.client.client.get("/entity-schemas");
