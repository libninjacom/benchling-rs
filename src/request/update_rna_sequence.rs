...
pub struct UpdateRnaSequenceRequest<'a> {
...
impl<'a> UpdateRnaSequenceRequest<'a> {
...
pub struct UpdateRnaSequenceRequired<'a> {
    pub rna_sequence_id: &'a str,
    pub aliases: &'a [&'a str],
    pub annotations: Vec<RnaAnnotation>,
...
impl<'a> UpdateRnaSequenceRequired<'a> {}
