...
pub struct ListMixturesRequest<'a> {
    ...
    pub ingredient_component_entity_ids: Option<String>,
    pub ingredient_component_entity_ids_any_of: Option<String>,
    pub author_ids_any_of: Option<String>,
}
impl<'a> ListMixturesRequest<'a> {
    pub async fn send(self) -> anyhow::Result<MixturesPaginatedList> {
        let mut r = self.client.client.get("/mixtures");
        ...
        if let Some(ref unwrapped) = self.ingredient_component_entity_ids {
            r = r.push_query("ingredientComponentEntityIds", &unwrapped.to_string());
        }
        if let Some(ref unwrapped) = self.ingredient_component_entity_ids_any_of {
            r = r
                .push_query(
    ...
    pub fn ingredient_component_entity_ids(
        mut self,
        ingredient_component_entity_ids: &str,
    ) -> Self {
        self
            .ingredient_component_entity_ids = Some(
            ingredient_component_entity_ids.to_owned(),
        );
        self
    }
    pub fn ingredient_component_entity_ids_any_of(
        mut self,
        ingredient_component_entity_ids_any_of: &str,
    ) -> Self {
        self
            .ingredient_component_entity_ids_any_of = Some(
            ingredient_component_entity_ids_any_of.to_owned(),
        );
        self
    }
