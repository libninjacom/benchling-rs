...
pub struct CreateTemplateNucleotideAlignmentRequest<'a> {
...
impl<'a> CreateTemplateNucleotideAlignmentRequest<'a> {
...
pub struct CreateTemplateNucleotideAlignmentRequired<'a> {
    pub algorithm: &'a str,
    pub files: Vec<serde_json::Value>,
    pub name: &'a str,
    pub template_sequence_id: &'a str,
}
impl<'a> CreateTemplateNucleotideAlignmentRequired<'a> {}
