...
pub struct ListDnaAlignmentsRequest<'a> {
...
impl<'a> ListDnaAlignmentsRequest<'a> {
    pub async fn send(self) -> anyhow::Result<DnaAlignmentsPaginatedList> {
        let mut r = self.client.client.get("/dna-alignments");
