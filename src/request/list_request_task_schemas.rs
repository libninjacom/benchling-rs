...
pub struct ListRequestTaskSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
    pub modified_at: Option<String>,
}
impl<'a> ListRequestTaskSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<RequestTaskSchemasPaginatedList> {
        let mut r = self.client.client.get("/request-task-schemas");
