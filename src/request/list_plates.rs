...
pub struct ListPlatesRequest<'a> {
...
impl<'a> ListPlatesRequest<'a> {
    pub async fn send(self) -> anyhow::Result<PlatesPaginatedList> {
        let mut r = self.client.client.get("/plates");
