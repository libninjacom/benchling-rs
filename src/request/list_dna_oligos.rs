...
pub struct ListDnaOligosRequest<'a> {
...
impl<'a> ListDnaOligosRequest<'a> {
    pub async fn send(self) -> anyhow::Result<DnaOligosPaginatedList> {
        let mut r = self.client.client.get("/dna-oligos");
