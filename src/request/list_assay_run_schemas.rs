...
pub struct ListAssayRunSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
    pub modified_at: Option<String>,
}
impl<'a> ListAssayRunSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<AssayRunSchemasPaginatedList> {
        let mut r = self.client.client.get("/assay-run-schemas");
