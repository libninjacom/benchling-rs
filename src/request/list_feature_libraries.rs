...
pub struct ListFeatureLibrariesRequest<'a> {
...
impl<'a> ListFeatureLibrariesRequest<'a> {
    pub async fn send(self) -> anyhow::Result<FeatureLibrariesPaginatedList> {
        let mut r = self.client.client.get("/feature-libraries");
