...
pub struct ListPlateSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
}
impl<'a> ListPlateSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<PlateSchemasPaginatedList> {
        let mut r = self.client.client.get("/plate-schemas");
