...
pub struct ListLocationSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
}
impl<'a> ListLocationSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<LocationSchemasPaginatedList> {
        let mut r = self.client.client.get("/location-schemas");
