...
pub struct BulkCreateDnaOligosRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub dna_oligos: Option<Vec<DnaOligoCreate>>,
}
impl<'a> BulkCreateDnaOligosRequest<'a> {
    pub async fn send(self) -> anyhow::Result<AsyncTaskLink> {
        let mut r = self.client.client.post("/dna-oligos:bulk-create");
    ...
    pub fn dna_oligos(mut self, dna_oligos: Vec<DnaOligoCreate>) -> Self {
