...
pub struct ListDnaSequencesRequest<'a> {
...
impl<'a> ListDnaSequencesRequest<'a> {
    pub async fn send(self) -> anyhow::Result<DnaSequencesPaginatedList> {
        let mut r = self.client.client.get("/dna-sequences");
