...
pub struct ListRnaOligosRequest<'a> {
...
impl<'a> ListRnaOligosRequest<'a> {
    pub async fn send(self) -> anyhow::Result<RnaOligosPaginatedList> {
        let mut r = self.client.client.get("/rna-oligos");
