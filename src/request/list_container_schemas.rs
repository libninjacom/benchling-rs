...
pub struct ListContainerSchemasRequest<'a> {
    pub(crate) client: &'a BenchlingClient,
    pub next_token: Option<String>,
    pub page_size: Option<i64>,
    pub modified_at: Option<String>,
}
impl<'a> ListContainerSchemasRequest<'a> {
    pub async fn send(self) -> anyhow::Result<ContainerSchemasPaginatedList> {
        let mut r = self.client.client.get("/container-schemas");
