...
pub struct ListOligosRequest<'a> {
...
impl<'a> ListOligosRequest<'a> {
    pub async fn send(self) -> anyhow::Result<OligosPaginatedList> {
        let mut r = self.client.client.get("/oligos");
